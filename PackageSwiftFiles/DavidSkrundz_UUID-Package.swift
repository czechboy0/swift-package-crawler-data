...
let package = Package(
	name: "UUID",
	dependencies: [
		.Package(url: "https://github.com/DavidSkrundz/Hash.git", versions: Version(0,1,0)..<Version(0,2,0)),
		.Package(url: "https://github.com/DavidSkrundz/LibC.git", versions: Version(0,2,0)..<Version(0,3,0)),
