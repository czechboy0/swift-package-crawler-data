...
let package = Package(
    ...
    dependencies: [
        ...
        .Package(url: "https://github.com/damuellen/HMAC.git", majorVersion: 0, minor: 8),
        .Package(url: "https://github.com/damuellen/SHA2.git", majorVersion: 0, minor: 8),
        ...
        .Package(url: "https://github.com/damuellen/engine.git", majorVersion: 0, minor: 1),

        // Console protocol and implementation for powering command line interface.
        .Package(url: "https://github.com/damuellen/console.git", majorVersion: 0, minor: 2)
    ],
    exclude: exclude
)
