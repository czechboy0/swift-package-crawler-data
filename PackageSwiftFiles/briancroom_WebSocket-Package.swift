...
let package = Package(
	...
	dependencies: [
		...
		.Package(url: "https://github.com/briancroom/HTTPClient.git", majorVersion: 0, minor: 6),
		.Package(url: "https://github.com/briancroom/HTTPSClient.git", majorVersion: 0, minor: 7),
